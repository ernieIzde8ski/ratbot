    ...
    async def information(self, ctx):
        ...
        embed = Embed(
            ...
            description=f"[GitHub](https://github.com/ernieIzde8ski/ratbot)\n"
                        f"[Bot Invite]({utils.oauth_url(self.bot.user.id, permissions=Permissions(8))})\n"
                        f"[bot invite but you have to think about it]({utils.oauth_url(self.bot.user.id, permissions=Permissions(201714752))})\n"
