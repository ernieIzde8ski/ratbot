...
class Administration(commands.Cog):
	...
	async def load(self, ctx, *, module):
		...
		try:
			...
			await ctx.send(f'{e.__class__.__name__}: {e}', allowed_mentions=discord.AllowedMentions.none())
		else:
	...
	@commands.is_owner()
	async def vessel(self, ctx, messageable: Union[commands.TextChannelConverter, commands.UserConverter, int, None], *, text: str):
