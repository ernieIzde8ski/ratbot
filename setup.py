...
if __name__ == "__main__":
    raise NotImplementedError(
        "File does not match current standards. Import data from a backup or proceed without instead. Necessary environment variables will be DISCORD_TOKEN and CURRENT_WEATHER_TOKEN (if loading the weather cog)."
    )
